//variables to get values from dom
...
// using Dom content load to charge data before document and save data into local storage  
...
// event listener to add items into the cart
cards.addEventListener('click', e => {
     addCarrito(e)
} )
// event listener to increase decrease items
items.addEventListener('click', e => {
    btnAccion(e)
})
// calling pseudo database in JSON called api. using async and await to asyncronus download data
...
// create product data cards using data from api. called the template document data template cards in the document.
...
const pintarFooter = () => {
    ...
    if(Object.keys(carrito).length === 0){
        footer.innerHTML = `<th scope="row" colspan="5">You don´t have selected any item!!</th>`
